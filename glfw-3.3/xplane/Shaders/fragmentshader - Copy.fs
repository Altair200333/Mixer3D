...
{
    vec4 v1 = texelFetch(VertexSampler0, 0);
    vec4 v2 = texelFetch(VertexSampler0, 1);
    vec4 v3 = texelFetch(VertexSampler0, 2);
    vec4 v4 = texelFetch(VertexSampler0, 3);
    vec4 v5 = texelFetch(VertexSampler0, 4);
    Polygon p;
    return polygons[id];
}
